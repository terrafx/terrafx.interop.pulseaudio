...
// Ported from include/pulse/stream.h in PulseAudio 12.2
...
namespace TerraFX.Interop
{
    public static unsafe partial class Pulse
    {
        ...
        public static extern pa_stream_state pa_stream_get_state([NativeTypeName("const pa_stream *")] pa_stream* p);
        ...
        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_stream_begin_write([NativeTypeName("pa_stream *")] pa_stream* p, [NativeTypeName("void **")] void** data, [NativeTypeName("size_t *")] nuint* nbytes);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_stream_cancel_write([NativeTypeName("pa_stream *")] pa_stream* p);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_stream_write([NativeTypeName("pa_stream *")] pa_stream* p, [NativeTypeName("const void *")] void* data, [NativeTypeName("size_t")] nuint nbytes, [NativeTypeName("pa_free_cb_t")] IntPtr free_cb, [NativeTypeName("int64_t")] nint offset, [NativeTypeName("pa_seek_mode_t")] pa_seek_mode seek);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_stream_write_ext_free([NativeTypeName("pa_stream *")] pa_stream* p, [NativeTypeName("const void *")] void* data, [NativeTypeName("size_t")] nuint nbytes, [NativeTypeName("pa_free_cb_t")] IntPtr free_cb, [NativeTypeName("void *")] void* free_cb_data, [NativeTypeName("int64_t")] nint offset, [NativeTypeName("pa_seek_mode_t")] pa_seek_mode seek);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_stream_peek([NativeTypeName("pa_stream *")] pa_stream* p, [NativeTypeName("const void **")] void** data, [NativeTypeName("size_t *")] nuint* nbytes);
        ...
        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_stream_get_time([NativeTypeName("pa_stream *")] pa_stream* s, [NativeTypeName("pa_usec_t *")] nuint* r_usec);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_stream_get_latency([NativeTypeName("pa_stream *")] pa_stream* s, [NativeTypeName("pa_usec_t *")] nuint* r_usec, [NativeTypeName("int *")] int* negative);
