...
// Ported from include/pulse/thread-mainloop.h in PulseAudio 12.2
...
namespace TerraFX.Interop
{
    public static unsafe partial class Pulse
    {
        ...
        [DllImport("libpulse", ExactSpelling = true)]
        public static extern void pa_threaded_mainloop_once_unlocked([NativeTypeName("pa_threaded_mainloop *")] pa_threaded_mainloop* m, [NativeTypeName("void (*)(pa_threaded_mainloop *, void *)")] IntPtr callback, [NativeTypeName("void *")] void* userdata);
    }
}
