...
{
    public partial struct pa_stream
    {
    }
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public unsafe delegate void pa_stream_notify_cb_t([NativeTypeName("pa_stream *")] pa_stream* p, [NativeTypeName("void *")] void* userdata);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public unsafe delegate void pa_stream_event_cb_t([NativeTypeName("pa_stream *")] pa_stream* p, [NativeTypeName("const char *")] sbyte* name, [NativeTypeName("pa_proplist *")] pa_proplist* pl, [NativeTypeName("void *")] void* userdata);

    public static unsafe partial class pulse
    {
        [DllImport(DllName, EntryPoint = "pa_stream_new", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_new_with_proplist", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_stream *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_new_extended", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_stream *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_unref", CallingConvention = CallingConvention.Cdecl)]
        public static extern void pa_stream_unref([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_ref", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_stream *")]
        public static extern pa_stream* pa_stream_ref([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_get_state", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_context", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_index", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("uint32_t")]
        public static extern uint pa_stream_get_index([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_get_device_index", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("uint32_t")]
        public static extern uint pa_stream_get_device_index([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_get_device_name", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("const char *")]
        public static extern sbyte* pa_stream_get_device_name([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_is_suspended", CallingConvention = CallingConvention.Cdecl)]
        public static extern int pa_stream_is_suspended([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_is_corked", CallingConvention = CallingConvention.Cdecl)]
        public static extern int pa_stream_is_corked([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_connect_playback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_connect_record", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_disconnect", CallingConvention = CallingConvention.Cdecl)]
        public static extern int pa_stream_disconnect([NativeTypeName("pa_stream *")] pa_stream* s);

        [DllImport(DllName, EntryPoint = "pa_stream_begin_write", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_cancel_write", CallingConvention = CallingConvention.Cdecl)]
        public static extern int pa_stream_cancel_write([NativeTypeName("pa_stream *")] pa_stream* p);

        [DllImport(DllName, EntryPoint = "pa_stream_write", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_write_ext_free", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_peek", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_drop", CallingConvention = CallingConvention.Cdecl)]
        public static extern int pa_stream_drop([NativeTypeName("pa_stream *")] pa_stream* p);

        [DllImport(DllName, EntryPoint = "pa_stream_writable_size", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("size_t")]
        public static extern UIntPtr pa_stream_writable_size([NativeTypeName("pa_stream *")] pa_stream* p);

        [DllImport(DllName, EntryPoint = "pa_stream_readable_size", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("size_t")]
        public static extern UIntPtr pa_stream_readable_size([NativeTypeName("pa_stream *")] pa_stream* p);

        [DllImport(DllName, EntryPoint = "pa_stream_drain", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_update_timing_info", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_state_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_write_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_read_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_overflow_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_underflow_index", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("int64_t")]
        public static extern IntPtr pa_stream_get_underflow_index([NativeTypeName("pa_stream *")] pa_stream* p);

        [DllImport(DllName, EntryPoint = "pa_stream_set_underflow_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_started_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_latency_update_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_moved_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_suspended_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_event_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_buffer_attr_callback", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_cork", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_flush", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_prebuf", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_trigger", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_name", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_time", CallingConvention = CallingConvention.Cdecl)]
        public static extern int pa_stream_get_time([NativeTypeName("pa_stream *")] pa_stream* s, [NativeTypeName("pa_usec_t *")] UIntPtr* r_usec);

        [DllImport(DllName, EntryPoint = "pa_stream_get_latency", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_timing_info", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_sample_spec", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_channel_map", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_format_info", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_buffer_attr", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_buffer_attr", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_update_sample_rate", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_proplist_update", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_proplist_remove", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("pa_operation *")]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_set_monitor_stream", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, EntryPoint = "pa_stream_get_monitor_stream", CallingConvention = CallingConvention.Cdecl)]
        [return: NativeTypeName("uint32_t")]
