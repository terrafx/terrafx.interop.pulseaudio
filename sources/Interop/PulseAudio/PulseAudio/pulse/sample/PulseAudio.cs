...
namespace TerraFX.Interop.PulseAudio
{
    public static unsafe partial class PulseAudio
    {
        ...
        [DllImport("libpulse", ExactSpelling = true)]
        [return: NativeTypeName("size_t")]
        public static extern nuint pa_sample_size_of_format(pa_sample_format_t f);
        ...
        [DllImport("libpulse", ExactSpelling = true)]
        public static extern pa_sample_spec* pa_sample_spec_init(pa_sample_spec* spec);
        ...
        public static extern sbyte* pa_sample_format_to_string(pa_sample_format_t f);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern pa_sample_format_t pa_parse_sample_format([NativeTypeName("const char *")] sbyte* format);
        ...
        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_sample_format_is_le(pa_sample_format_t f);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_sample_format_is_be(pa_sample_format_t f);
        ...
        public const pa_sample_format_t PA_SAMPLE_S16NE = PA_SAMPLE_S16LE;

        [NativeTypeName("#define PA_SAMPLE_FLOAT32NE PA_SAMPLE_FLOAT32LE")]
        public const pa_sample_format_t PA_SAMPLE_FLOAT32NE = PA_SAMPLE_FLOAT32LE;

        [NativeTypeName("#define PA_SAMPLE_S32NE PA_SAMPLE_S32LE")]
        public const pa_sample_format_t PA_SAMPLE_S32NE = PA_SAMPLE_S32LE;

        [NativeTypeName("#define PA_SAMPLE_S24NE PA_SAMPLE_S24LE")]
        public const pa_sample_format_t PA_SAMPLE_S24NE = PA_SAMPLE_S24LE;

        [NativeTypeName("#define PA_SAMPLE_S24_32NE PA_SAMPLE_S24_32LE")]
        public const pa_sample_format_t PA_SAMPLE_S24_32NE = PA_SAMPLE_S24_32LE;

        [NativeTypeName("#define PA_SAMPLE_S16RE PA_SAMPLE_S16BE")]
        public const pa_sample_format_t PA_SAMPLE_S16RE = PA_SAMPLE_S16BE;

        [NativeTypeName("#define PA_SAMPLE_FLOAT32RE PA_SAMPLE_FLOAT32BE")]
        public const pa_sample_format_t PA_SAMPLE_FLOAT32RE = PA_SAMPLE_FLOAT32BE;

        [NativeTypeName("#define PA_SAMPLE_S32RE PA_SAMPLE_S32BE")]
        public const pa_sample_format_t PA_SAMPLE_S32RE = PA_SAMPLE_S32BE;

        [NativeTypeName("#define PA_SAMPLE_S24RE PA_SAMPLE_S24BE")]
        public const pa_sample_format_t PA_SAMPLE_S24RE = PA_SAMPLE_S24BE;

        [NativeTypeName("#define PA_SAMPLE_S24_32RE PA_SAMPLE_S24_32BE")]
        public const pa_sample_format_t PA_SAMPLE_S24_32RE = PA_SAMPLE_S24_32BE;

        [NativeTypeName("#define PA_SAMPLE_FLOAT32 PA_SAMPLE_FLOAT32NE")]
        public const pa_sample_format_t PA_SAMPLE_FLOAT32 = PA_SAMPLE_FLOAT32LE;
