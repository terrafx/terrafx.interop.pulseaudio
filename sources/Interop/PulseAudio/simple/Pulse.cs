...
// Ported from include/pulse/simple.h in PulseAudio 12.2
...
namespace TerraFX.Interop
{
    public static unsafe partial class Pulse
    {
        ...
        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_simple_write([NativeTypeName("pa_simple *")] pa_simple* s, [NativeTypeName("const void *")] void* data, [NativeTypeName("size_t")] nuint bytes, [NativeTypeName("int *")] int* error);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_simple_drain([NativeTypeName("pa_simple *")] pa_simple* s, [NativeTypeName("int *")] int* error);

        [DllImport("libpulse", ExactSpelling = true)]
        public static extern int pa_simple_read([NativeTypeName("pa_simple *")] pa_simple* s, [NativeTypeName("void *")] void* data, [NativeTypeName("size_t")] nuint bytes, [NativeTypeName("int *")] int* error);

        [DllImport("libpulse", ExactSpelling = true)]
        [return: NativeTypeName("pa_usec_t")]
        public static extern nuint pa_simple_get_latency([NativeTypeName("pa_simple *")] pa_simple* s, [NativeTypeName("int *")] int* error);
